...
- Vérifier qu'un participant en attente dont les ECTS ont été validés est visible par un participant actif, mais ne reçoit lui-même ni lignes ni compteur avant l'échéance de 48 heures.
