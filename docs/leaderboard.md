...
Le retrait masque immédiatement le profil à tous et déclenche un délai de 48 heures avant une éventuelle réactivation. L'effacement distinct est lui aussi immédiat : il supprime le consentement et les données propres au leaderboard sans supprimer le compte, l'identité officielle ni les notes. Une suppression complète du compte est également disponible auprès de l'administrateur. Les sauvegardes chiffrées suivent leur cycle normal de rétention ; les données effacées ne réapparaissent pas dans la base active.
