...
5. le retrait et l'effacement ordinaires deviennent disponibles après 48 heures supplémentaires d'exposition avec accès.

Le retrait ordinaire masque ensuite le profil à tous et déclenche un délai de 48 heures avant une éventuelle réactivation. Pendant la période d'engagement, une urgence de confidentialité passe par l'administrateur, qui peut suspendre, retirer ou effacer immédiatement la participation. L'effacement distinct supprime le consentement et les données propres au leaderboard sans supprimer le compte, l'identité officielle ni les notes. Une suppression complète du compte est également disponible auprès de l'administrateur. Les sauvegardes chiffrées suivent leur cycle normal de rétention ; les données effacées ne réapparaissent pas dans la base active.
