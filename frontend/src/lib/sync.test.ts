...
const status = (state: ManualSyncStatus["state"]): ManualSyncStatus => ({
  ...
  pass_access: {
    ...
    service_session: {
      ...
      beta: true,
      retention_days: 30,
      established_at: "2026-07-16T09:00:00Z",
      expires_at: "2026-08-15T09:00:00Z",
      last_used_at: "2026-07-16T10:02:28Z",
      pass_last_success_at: "2026-07-16T10:02:28Z",
      hub_state: "ready",
      hub_last_attempt_at: "2026-07-16T10:02:28Z",
      hub_last_success_at: "2026-07-16T10:02:28Z",
    },
    quota: {
