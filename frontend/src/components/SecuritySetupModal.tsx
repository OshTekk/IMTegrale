...
export function SecuritySetupModal({ open, onComplete }: { open: boolean; onComplete: () => void }) {
  ...
  return (
    <Modal open={open} title="Sécuriser tes prochaines connexions" description="Choisis une ou plusieurs méthodes, ou continue simplement avec ton compte IMT." onClose={() => undefined} size="large">
