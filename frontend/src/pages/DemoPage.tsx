...
const steps: DemoStep[] = [
  ...
  { title: "PASS vérifie le compte", short: "Vérification", detail: "Le serveur suit uniquement les origines CAS et PASS autorisées, refuse les redirections externes et borne la durée comme la taille des réponses.", proof: "Un échec déclenche un délai progressif ; une panne PASS n'est pas comptée comme une erreur utilisateur.", node: "pass", icon: KeyRound },
  ...
  { title: "Profil et notes brutes sont importés", short: "Import PASS", detail: "IMTégrale récupère l'identité officielle, le campus courant, le cursus, la promotion et les évaluations. Chaque ligne reste rattachée au compte propriétaire.", proof: "Rennes, Brest ou Nantes proviennent de la fiche PASS et ne sont pas modifiables côté étudiant.", node: "vault", icon: Database },
  ...
  { title: "Le classement exige un second consentement", short: "Leaderboard", detail: "L'identité PASS devient nominative seulement après activation. L'instantané ECTS est figé puis validé, les classements GPA et moyenne restent séparés et l'accès du nouvel inscrit attend 48 heures.", proof: "Le retrait est immédiat ; une réactivation est bloquée pendant 48 heures.", node: "optional", icon: Trophy, optional: true },
];
...
const nodes: Array<{ id: DemoNode; label: string; icon: LucideIcon }> = [
  ...
  { id: "pass", label: "CAS / PASS", icon: Server },
