...
const steps: DemoStep[] = [
  ...
  { title: "Les données académiques sont importées", short: "Import IMT", detail: "PASS fournit l'identité, le campus, le cursus, la promotion et les évaluations. COMPETENCES complète les intitulés et crédits ECTS officiels de chaque UE.", proof: "Les métadonnées officielles sont identifiées dans l'interface et ne sont pas modifiables côté étudiant.", node: "vault", icon: Database },
